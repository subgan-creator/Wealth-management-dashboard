...
function generateMockRequests(): WorkRequest[] {
  ...
  const sampleRequests = [
    ...
    {
      title: 'Missing Bank Statements - Follow Up',
      businessEventId: 'be-1',
      subEventId: 'se-1-2',
      priority: 'high' as const,
      status: 'new' as const,
    ...
    {
      title: 'Power of Attorney - Awaiting Notarization',
      businessEventId: 'be-1',
      subEventId: 'se-1-2',
      priority: 'high' as const,
      status: 'pending-review' as const,
      ...
      advisorName: 'Emily Zhang',
    },
    {
      title: 'Trust Document Upload Required',
      businessEventId: 'be-1',
      subEventId: 'se-1-2',
      priority: 'normal' as const,
      status: 'new' as const,
